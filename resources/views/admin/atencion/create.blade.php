<x-layouts.app :title="__('Nueva Atención')">
    <div class="max-w-3xl mx-auto p-6 bg-white dark:bg-zinc-800 shadow-lg rounded-lg">
        <h1 class="text-3xl font-bold text-center mb-6">Crear Atención</h1>
        <form action="{{ route('admin.atencion.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <select name="solicitud_id" id="solicitud_id" class="mt-1 block w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
            ...
            <div>
                ...
                <textarea name="descripcion" id="descripcion" rows="4" class="mt-1 block w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" placeholder="Detalle la atención..."></textarea>
            </div>

            <!-- Fecha de Inicio (opcional) -->
            <div>
                <label for="fecha_inicio" class="block font-medium text-gray-700 dark:text-gray-300">Fecha de Inicio</label>
                <input type="datetime-local" name="fecha_inicio" id="fecha_inicio" class="mt-1 block w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
            </div>

            <!-- Fecha de Fin (opcional) -->
            <div>
                <label for="fecha_fin" class="block font-medium text-gray-700 dark:text-gray-300">Fecha de Fin</label>
                <input type="datetime-local" name="fecha_fin" id="fecha_fin" class="mt-1 block w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
            </div>
