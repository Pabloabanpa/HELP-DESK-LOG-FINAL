<x-layouts.app :title="__('Crear Solicitud')">
    <div class="max-w-3xl mx-auto p-6 bg-white dark:bg-zinc-800 shadow-lg rounded-lg">
        <h1 class="text-3xl font-bold text-center mb-6">Crear Solicitud</h1>
        <form action="{{ route('admin.solicitud.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div id="equipoSection">
                ...
                <input type="text" name="equipo_id" id="equipo_id" class="mt-1 block w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500">
            </div>
            ...
            <div>
                ...
                <textarea name="descripcion" id="descripcion" rows="4" class="mt-1 block w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"></textarea>
            </div>
